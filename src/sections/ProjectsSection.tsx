...
export default function ProjectsSection({ data }: ProjectsSectionProps) {
    ...
    return (
        <Section id="projects" className="bg-[#f4f2ee] text-[#111] pt-32 pb-48 selection:bg-[#111] selection:text-[#f4f2ee]">
            <Container>
                <div className="max-w-3xl mx-auto">
                        ...
                        {projects.map((project, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-6 gap-2">
                                    <p className="text-[15px] text-[#444] font-sans font-medium">
                                        {project.summary}
                                    </p>
                                    <div className="flex gap-4 text-[10px] tracking-[0.15em] font-bold text-[#999] uppercase shrink-0">
                                        {project.status && (
                                ...
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4 border-y border-[#e8e6e2] py-2">
                                    <div className="text-[10px] tracking-[0.2em] font-bold text-[#999] uppercase">
                    ...
                    <div className="mt-16 pt-12 border-t border-[#d8d4cf] flex gap-8">
                        <Link
