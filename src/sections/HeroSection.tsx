...
export default function HeroSection() {
    return (
        <section id="hero" className="w-full bg-[#f4f2ee] text-[#111] min-h-screen flex flex-col overflow-hidden">
            <div className="mx-auto w-full max-w-[1280px] px-[96px] pt-[140px] flex-1 flex flex-col">
                {/* 1. STRUCTURAL GRID */}
                <div className="flex flex-row items-start justify-between">
                    {/* Left Column - Content */}
                    <div className="flex-1">
                        <h1 className="text-[82px] font-sans font-semibold leading-[1.05] tracking-tight text-[#111] mb-[28px]">
                            Aseem Sangalay
                        </h1>

                        <h2 className="text-[34px] font-serif italic text-[#222] leading-[1.3] mb-[42px]">
                            Designing systems that endure.
                        </h2>

                        <p className="text-[12px] tracking-[0.15em] text-[#888] uppercase font-sans font-medium mb-[46px]">
